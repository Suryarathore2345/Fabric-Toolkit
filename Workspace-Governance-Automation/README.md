...
**Owner:** Pankaj Bana
**Workspace:** MS Fabric Demo (`3cb31722-1925-4f2b-93ca-139f4e816755`)
**Governance admin (report recipient):** SURYADEV.RATHORE@XEBIA.COM
...
│
└── Pipeline/
    └── Governance_Pipeline               orchestrates everything, on a schedule
```
...
resolved_date, deleted_date, workspace_id.
...
| admin_email | SURYADEV.RATHORE@XEBIA.COM | Dashboard recipient |
...
| workspace_ids | 3cb31722-... | Comma-separated workspaces to scan |
| test_mode_recipient | suryadev.rathore@xebia.com | Redirect ALL emails here (blank to disable) |
...
## 7. The pipeline — `Governance_Pipeline`
...
3. Build/import `Governance_Pipeline`, sign in on the Outlook activities.
...
## 12. Current state (as of this README)
